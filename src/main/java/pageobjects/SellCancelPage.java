...
public class SellCancelPage {
    ...
    public void getSellOrderStatus(){
        driver.findElement(orderStatus).getText();
    }

    public void rightClickOnPlacedOrder(){
    ...
    public void clickPlacedSellOrderCancelBtn(){
        driver.findElement(placedOrderCancelBtn).click();
    }

    //Reset
    public void clickPlacedSellOrderResetBtn(){
    ...
    public void clickPlacedSellOrderConfirmCancellationBtn(){
        driver.findElement(placedOrderConfirmCancellationBtn).click();
    }

    //Cancel Confirmation
    public void clickPlacedOrderCancelConfirmationBtn(){
